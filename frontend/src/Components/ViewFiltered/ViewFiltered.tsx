...
const ViewFiltered: React.FC<ModalProps> = ({ handleCloseClick, recipeData }) => {
  ...
  return (
    <div className="viewFiltered__container">
      <div className="viewFiltered__container-header">
        <h1>{recipeData?.title}</h1>
        <button
          className="close-btn edit-btn-styles"
      ...
      <div className="home__container-overlay" ref={overlayRef}>
        {editVisibility && (
          <EditRecipe
            handleCloseClick={handleEditCloseClick}
            recipeData={recipeData}
          />
        )}
      </div>
      <div className="viewFiltered__container-description">
        <h3>{recipeData?.description}</h3>
      </div>
      <div className="viewFiltered__container-body">
